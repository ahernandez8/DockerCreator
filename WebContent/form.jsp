...
<%@page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@page import="edu.ucam.servlets.Subir"%>
...
<!-- main -->
	...
	<form action="Subir" method="post" enctype="multipart/form-data" id="formIndex" >
		<input type= "file" id="ARCHIVO" class="drop" required>
		<input type="submit" value="Subir archivo">
	</form>
	
	
	<p> Archivo que vas a subir: ${requestScope.fileName}</p>
...
<div class="wthree-text">
	...
	<a href="<%=request.getContextPath()%>/resultados.jsp"><button
			form="formIndex"
			onclick="changeSPI()"
			class="btn btn-success" type="submit" id="generar">Generar</button></a>
