...
<%
	...
	<p>	Contenedor 1:</p>
	<p>	Base de datos seleccionada: <%= request.getParameter("BBDD")%></p>
	<p> Dataset seleccionado: <%= request.getParameter("DATA")%></p>

	<p>	Contenedor 2:</p>
	<p>	IDE seleccionado: <%= request.getParameter("IDE")%></p>
	<p> Librería seleccionada: <%= request.getParameter("LIBRARY")%></p>
	
	<%
	if(request.getParameter("BUILD")==null)
	{
		%>
		<p> ¿Se contruyen sus imágenes automaticamente?: No</p>
		<% 
	}
	else{
	%>
		<p> ¿Se contruyen sus imágenes automaticamente?: Si</p>
	<%
		}
	%>
	<%
	...
	{
		%>
		<p> ¿Se suben sus imágenes a DockerHub?: No</p>
		<% 
	}
	else{
	%>
		<p> ¿Se suben sus imágenes a DockerHub?: Si</p>
	<%
		}
	%>
			</div>
