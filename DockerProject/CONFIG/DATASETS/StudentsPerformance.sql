...
CREATE TABLE IF NOT EXISTS StudentsPerformance (
    `gender` VARCHAR(6) CHARACTER SET utf8,
    `race_ethnicity` VARCHAR(7) CHARACTER SET utf8,
    `parental_level_of_education` VARCHAR(18) CHARACTER SET utf8,
    `lunch` VARCHAR(12) CHARACTER SET utf8,
    `test_preparation_course` VARCHAR(9) CHARACTER SET utf8,
    `math_score` INT,
    `reading_score` INT,
    `writing_score` INT
);
